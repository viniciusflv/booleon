...
describe('Cursor', () => {
  ...
  test('cr_default', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_default" cr_default />,
    );
  ...
  test('cr_pointer', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_pointer" cr_pointer />,
    );
  ...
  test('cr_disallowed', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_disallowed" cr_disallowed />,
    );
  ...
  test('cr_cross', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_cross" cr_cross />,
    );
  ...
  test('cr_grabbing', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_grabbing" cr_grabbing />,
    );
  ...
  test('cry_resize', () => {
    const { getByTestId } = render(
      <View.div data-testid="cry_resize" cry_resize />,
    );
  ...
  test('cra_resize', () => {
    const { getByTestId } = render(
      <View.div data-testid="cra_resize" cra_resize />,
    );
  ...
  test('crb_resize', () => {
    const { getByTestId } = render(
      <View.div data-testid="crb_resize" crb_resize />,
    );
  ...
  test('crx_resize', () => {
    const { getByTestId } = render(
      <View.div data-testid="crx_resize" crx_resize />,
    );
  ...
  test('cr_no_drop', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_no_drop" cr_no_drop />,
    );
  ...
  test('cr_progress', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_progress" cr_progress />,
    );
  ...
  test('cr_zoom_in', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_zoom_in" cr_zoom_in />,
    );
  ...
  test('cr_zoom_out', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_zoom_out" cr_zoom_out />,
    );
  ...
  test('cr_noevents', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_noevents" cr_noevents />,
    );
  ...
  test('cr_events', () => {
    const { getByTestId } = render(
      <View.div data-testid="cr_events" cr_events />,
    );
  ...
  test('cr_url', () => {
    ...
    const { getByTestId } = render(
      <View.div data-testid="cr_url" cr_url={cr_url} />,
    );
