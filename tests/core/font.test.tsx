...
describe('Font', () => {
  describe('Style', () => {
    ...
    test('f_italic', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_italic" f_italic />,
      );
  ...
  describe('Family', () => {
    test('ff_Fira_Code', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ff_Fira_Code" ff_Fira_Code />,
      );
    ...
    test('ff_sans', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ff_sans" ff_sans />,
      );
    ...
    test('ff_serif', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ff_serif" ff_serif />,
      );
    ...
    test('ff_mono', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ff_mono" ff_mono />,
      );
  ...
  describe('User Select', () => {
    test('fsl_none', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fsl_none" fsl_none />,
      );
    ...
    test('fsl_text', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fsl_text" fsl_text />,
      );
    ...
    test('fsl_all', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fsl_all" fsl_all />,
      );
    ...
    test('fsl_auto', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fsl_auto" fsl_auto />,
      );
  ...
  describe('Weight', () => {
    test('fw_lightest', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_lightest" fw_lightest />,
      );
    ...
    test('fw_lighter', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_lighter" fw_lighter />,
      );
    ...
    test('fw_light', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_light" fw_light />,
      );
    ...
    test('fw_normal', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_normal" fw_normal />,
      );
    ...
    test('fw_medium', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_medium" fw_medium />,
      );
    ...
    test('fw_semibold', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_semibold" fw_semibold />,
      );
    ...
    test('fw_bold', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_bold" fw_bold />,
      );
    ...
    test('fw_bolder', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_bolder" fw_bolder />,
      );
    ...
    test('fw_black', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fw_black" fw_black />,
      );
  ...
  describe('Spacing', () => {
    ...
    test('ls_neg_10', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ls_neg_10" ls_neg_10 />,
      );
  ...
  describe('List Item', () => {
    test('li_none', () => {
      const { getByTestId } = render(
        <Text.span data-testid="li_none" li_none />,
      );
    ...
    test('li_disc', () => {
      const { getByTestId } = render(
        <Text.span data-testid="li_disc" li_disc />,
      );
    ...
    test('li_decimal', () => {
      const { getByTestId } = render(
        <Text.span data-testid="li_decimal" li_decimal />,
      );
    ...
    test('li_inside', () => {
      const { getByTestId } = render(
        <Text.span data-testid="li_inside" li_inside />,
      );
    ...
    test('li_outside', () => {
      const { getByTestId } = render(
        <Text.span data-testid="li_outside" li_outside />,
      );
  ...
  describe('Align', () => {
    test('fa_left', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fa_left" fa_left />,
      );
    ...
    test('fa_center', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fa_center" fa_center />,
      );
    ...
    test('fa_right', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fa_right" fa_right />,
      );
    ...
    test('fa_justify', () => {
      const { getByTestId } = render(
        <Text.span data-testid="fa_justify" fa_justify />,
      );
  ...
  describe('Transform', () => {
    test('ft_uppercase', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ft_uppercase" ft_uppercase />,
      );
    ...
    test('ft_lowercase', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ft_lowercase" ft_lowercase />,
      );
    ...
    test('ft_normal', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ft_normal" ft_normal />,
      );
    ...
    test('ft_capitalize', () => {
      const { getByTestId } = render(
        <Text.span data-testid="ft_capitalize" ft_capitalize />,
      );
  ...
  describe('Decoration', () => {
    test('f_underline', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_underline" f_underline />,
      );
    ...
    test('f_line_through', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_line_through" f_line_through />,
      );
    ...
    test('f_no_underline', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_no_underline" f_no_underline />,
      );
  ...
  describe('Wrap', () => {
    test('f_wrap_space', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_wrap_space" f_wrap_space />,
      );
    ...
    test('f_wrap_word', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_wrap_word" f_wrap_word />,
      );
    ...
    test('f_wrap_letter', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_wrap_letter" f_wrap_letter />,
      );
    ...
    test('f_truncate', () => {
      const { getByTestId } = render(
        <Text.span data-testid="f_truncate" f_truncate />,
      );
