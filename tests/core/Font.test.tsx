...
describe('Font', () => {
  ...
  describe('Selection', () => {
    test('fsl_none', () => {
      const component = renderer.create(<Text fsl_none />).toJSON();
      expect(component).toHaveStyleRule('user-select', 'none');
    });

    test('fsl_text', () => {
      const component = renderer.create(<Text fsl_text />).toJSON();
      expect(component).toHaveStyleRule('user-select', 'text');
    });

    test('fsl_all', () => {
      const component = renderer.create(<Text fsl_all />).toJSON();
      expect(component).toHaveStyleRule('user-select', 'all');
    });

    test('fsl_auto', () => {
      const component = renderer.create(<Text fsl_auto />).toJSON();
      expect(component).toHaveStyleRule('user-select', 'auto');
    });
  });
