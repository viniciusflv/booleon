...
describe('Padding', () => {
  describe('XY', () => {
    test('p_0', () => {
      const component = renderer.create(<View p_0 />).toJSON();
    ...
    test('p_sm', () => {
      const component = renderer.create(<View p_sm />).toJSON();
      expect(component).toHaveStyleRule('padding', '.5rem');
    });
    test('p_md', () => {
      const component = renderer.create(<View p_md />).toJSON();
      expect(component).toHaveStyleRule('padding', '1rem');
    });
    test('p_lg', () => {
      const component = renderer.create(<View p_lg />).toJSON();
      expect(component).toHaveStyleRule('padding', '2rem');
    });
    test('p_xl', () => {
      const component = renderer.create(<View p_xl />).toJSON();
      expect(component).toHaveStyleRule('padding', '4rem');
    });
  });
  describe('X', () => {
    test('px_0', () => {
      const component = renderer.create(<View px_0 />).toJSON();
  ...
  describe('Y', () => {
    test('py_0', () => {
      const component = renderer.create(<View py_0 />).toJSON();
  ...
  describe('Top', () => {
    test('pt_0', () => {
      const component = renderer.create(<View pt_0 />).toJSON();
      expect(component).toHaveStyleRule('padding-top', '0');
    });
    test('pt_auto', () => {
    ...
    test('pt_xs', () => {
      const component = renderer.create(<View pt_xs />).toJSON();
      expect(component).toHaveStyleRule('padding-top', '.25rem');
    });
    test('pt_sm', () => {
      const component = renderer.create(<View pt_sm />).toJSON();
      expect(component).toHaveStyleRule('padding-top', '.5rem');
    });
    test('pt_md', () => {
      const component = renderer.create(<View pt_md />).toJSON();
      expect(component).toHaveStyleRule('padding-top', '1rem');
    });
    test('pt_lg', () => {
      const component = renderer.create(<View pt_lg />).toJSON();
      expect(component).toHaveStyleRule('padding-top', '2rem');
    });
    test('pt_xl', () => {
      const component = renderer.create(<View pt_xl />).toJSON();
      expect(component).toHaveStyleRule('padding-top', '4rem');
    });
  });
  describe('Bottom', () => {
    test('pb_0', () => {
      const component = renderer.create(<View pb_0 />).toJSON();
      expect(component).toHaveStyleRule('padding-bottom', '0');
    });
    test('pb_auto', () => {
    ...
    test('pb_xs', () => {
      const component = renderer.create(<View pb_xs />).toJSON();
      expect(component).toHaveStyleRule('padding-bottom', '.25rem');
    });
    test('pb_sm', () => {
      const component = renderer.create(<View pb_sm />).toJSON();
      expect(component).toHaveStyleRule('padding-bottom', '.5rem');
    });
    test('pb_md', () => {
      const component = renderer.create(<View pb_md />).toJSON();
      expect(component).toHaveStyleRule('padding-bottom', '1rem');
    });
    test('pb_lg', () => {
      const component = renderer.create(<View pb_lg />).toJSON();
      expect(component).toHaveStyleRule('padding-bottom', '2rem');
    });
    test('pb_xl', () => {
      const component = renderer.create(<View pb_xl />).toJSON();
      expect(component).toHaveStyleRule('padding-bottom', '4rem');
    });
  });
  describe('Left', () => {
    test('pl_0', () => {
      const component = renderer.create(<View pl_0 />).toJSON();
      expect(component).toHaveStyleRule('padding-left', '0');
    });
    test('pl_auto', () => {
    ...
    test('pl_xs', () => {
      const component = renderer.create(<View pl_xs />).toJSON();
      expect(component).toHaveStyleRule('padding-left', '.25rem');
    });
    test('pl_sm', () => {
      const component = renderer.create(<View pl_sm />).toJSON();
      expect(component).toHaveStyleRule('padding-left', '.5rem');
    });
    test('pl_md', () => {
      const component = renderer.create(<View pl_md />).toJSON();
      expect(component).toHaveStyleRule('padding-left', '1rem');
    });
    test('pl_lg', () => {
      const component = renderer.create(<View pl_lg />).toJSON();
      expect(component).toHaveStyleRule('padding-left', '2rem');
    });
    test('pl_xl', () => {
      const component = renderer.create(<View pl_xl />).toJSON();
      expect(component).toHaveStyleRule('padding-left', '4rem');
    });
  });
  describe('Right', () => {
    test('pr_0', () => {
      const component = renderer.create(<View pr_0 />).toJSON();
      expect(component).toHaveStyleRule('padding-right', '0');
    });
    test('pr_auto', () => {
    ...
    test('pr_xs', () => {
      const component = renderer.create(<View pr_xs />).toJSON();
      expect(component).toHaveStyleRule('padding-right', '.25rem');
    });
    test('pr_sm', () => {
      const component = renderer.create(<View pr_sm />).toJSON();
      expect(component).toHaveStyleRule('padding-right', '.5rem');
    });
    test('pr_md', () => {
      const component = renderer.create(<View pr_md />).toJSON();
      expect(component).toHaveStyleRule('padding-right', '1rem');
    });
    test('pr_lg', () => {
      const component = renderer.create(<View pr_lg />).toJSON();
      expect(component).toHaveStyleRule('padding-right', '2rem');
    });
    test('pr_xl', () => {
      const component = renderer.create(<View pr_xl />).toJSON();
      expect(component).toHaveStyleRule('padding-right', '4rem');
    });
  });
});