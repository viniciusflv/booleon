...
describe('Margin', () => {
  describe('XY', () => {
    ...
    test('m_sm', () => {
      const component = renderer.create(<View m_sm />).toJSON();
      expect(component).toHaveStyleRule('margin', '.5rem');
    });
    test('m_md', () => {
      const component = renderer.create(<View m_md />).toJSON();
      expect(component).toHaveStyleRule('margin', '1rem');
    });
    test('m_lg', () => {
      const component = renderer.create(<View m_lg />).toJSON();
      expect(component).toHaveStyleRule('margin', '2rem');
    });
    test('m_xl', () => {
      const component = renderer.create(<View m_xl />).toJSON();
      expect(component).toHaveStyleRule('margin', '4rem');
    });
  });
  describe('X', () => {
    test('mx_0', () => {
      const component = renderer.create(<View mx_0 />).toJSON();
  ...
  describe('Y', () => {
    test('my_0', () => {
      const component = renderer.create(<View my_0 />).toJSON();
  ...
  describe('Top', () => {
    test('mt_0', () => {
      const component = renderer.create(<View mt_0 />).toJSON();
      expect(component).toHaveStyleRule('margin-top', '0');
    });
    test('mt_auto', () => {
    ...
    test('mt_xs', () => {
      const component = renderer.create(<View mt_xs />).toJSON();
      expect(component).toHaveStyleRule('margin-top', '.25rem');
    });
    test('mt_sm', () => {
      const component = renderer.create(<View mt_sm />).toJSON();
      expect(component).toHaveStyleRule('margin-top', '.5rem');
    });
    test('mt_md', () => {
      const component = renderer.create(<View mt_md />).toJSON();
      expect(component).toHaveStyleRule('margin-top', '1rem');
    });
    test('mt_lg', () => {
      const component = renderer.create(<View mt_lg />).toJSON();
      expect(component).toHaveStyleRule('margin-top', '2rem');
    });
    test('mt_xl', () => {
      const component = renderer.create(<View mt_xl />).toJSON();
      expect(component).toHaveStyleRule('margin-top', '4rem');
    });
  });
  describe('Bottom', () => {
    test('mb_0', () => {
      const component = renderer.create(<View mb_0 />).toJSON();
      expect(component).toHaveStyleRule('margin-bottom', '0');
    });
    test('mb_auto', () => {
    ...
    test('mb_xs', () => {
      const component = renderer.create(<View mb_xs />).toJSON();
      expect(component).toHaveStyleRule('margin-bottom', '.25rem');
    });
    test('mb_sm', () => {
      const component = renderer.create(<View mb_sm />).toJSON();
      expect(component).toHaveStyleRule('margin-bottom', '.5rem');
    });
    test('mb_md', () => {
      const component = renderer.create(<View mb_md />).toJSON();
      expect(component).toHaveStyleRule('margin-bottom', '1rem');
    });
    test('mb_lg', () => {
      const component = renderer.create(<View mb_lg />).toJSON();
      expect(component).toHaveStyleRule('margin-bottom', '2rem');
    });
    test('mb_xl', () => {
      const component = renderer.create(<View mb_xl />).toJSON();
      expect(component).toHaveStyleRule('margin-bottom', '4rem');
    });
  });
  describe('Left', () => {
    test('ml_0', () => {
      const component = renderer.create(<View ml_0 />).toJSON();
      expect(component).toHaveStyleRule('margin-left', '0');
    });
    test('ml_auto', () => {
    ...
    test('ml_xs', () => {
      const component = renderer.create(<View ml_xs />).toJSON();
      expect(component).toHaveStyleRule('margin-left', '.25rem');
    });
    test('ml_sm', () => {
      const component = renderer.create(<View ml_sm />).toJSON();
      expect(component).toHaveStyleRule('margin-left', '.5rem');
    });
    test('ml_md', () => {
      const component = renderer.create(<View ml_md />).toJSON();
      expect(component).toHaveStyleRule('margin-left', '1rem');
    });
    test('ml_lg', () => {
      const component = renderer.create(<View ml_lg />).toJSON();
      expect(component).toHaveStyleRule('margin-left', '2rem');
    });
    test('ml_xl', () => {
      const component = renderer.create(<View ml_xl />).toJSON();
      expect(component).toHaveStyleRule('margin-left', '4rem');
    });
  });
  describe('Right', () => {
    test('mr_0', () => {
      const component = renderer.create(<View mr_0 />).toJSON();
      expect(component).toHaveStyleRule('margin-right', '0');
    });
    test('mr_auto', () => {
    ...
    test('mr_xs', () => {
      const component = renderer.create(<View mr_xs />).toJSON();
      expect(component).toHaveStyleRule('margin-right', '.25rem');
    });
    test('mr_sm', () => {
      const component = renderer.create(<View mr_sm />).toJSON();
      expect(component).toHaveStyleRule('margin-right', '.5rem');
    });
    test('mr_md', () => {
      const component = renderer.create(<View mr_md />).toJSON();
      expect(component).toHaveStyleRule('margin-right', '1rem');
    });
    test('mr_lg', () => {
      const component = renderer.create(<View mr_lg />).toJSON();
      expect(component).toHaveStyleRule('margin-right', '2rem');
    });
    test('mr_xl', () => {
      const component = renderer.create(<View mr_xl />).toJSON();
      expect(component).toHaveStyleRule('margin-right', '4rem');
    });
  });
});