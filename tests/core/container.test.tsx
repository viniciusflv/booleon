...
describe('Container', () => {
  describe('Content', () => {
    test('content default', () => {
      const { getByTestId } = render(
        <View.div data-testid="content" content />,
      );
    ...
    test('content', () => {
      const { getByTestId } = render(
        <View.div data-testid="content" content="X" />,
      );
    ...
    test('op_PERCENTAGE', () => {
      const { getByTestId } = render(
        <View.div data-testid="op_PERCENTAGE" op_10 />,
      );
  ...
  describe('Placement', () => {
    describe('Top', () => {
      ...
      test('top_neg', () => {
        const { getByTestId } = render(
          <View.div data-testid="top_neg" top_neg />,
        );
    ...
    describe('Bottom', () => {
      ...
      test('bottom', () => {
        const { getByTestId } = render(
          <View.div data-testid="bottom" bottom />,
        );
      ...
      test('bottom_neg', () => {
        const { getByTestId } = render(
          <View.div data-testid="bottom_neg" bottom_neg />,
        );
    ...
    describe('Left', () => {
      ...
      test('left_neg', () => {
        const { getByTestId } = render(
          <View.div data-testid="left_neg" left_neg />,
        );
    ...
    describe('Right', () => {
      ...
      test('right_neg', () => {
        const { getByTestId } = render(
          <View.div data-testid="right_neg" right_neg />,
        );
    ...
    describe('Inset', () => {
      ...
      test('inset_x', () => {
        const { getByTestId } = render(
          <View.div data-testid="inset_x" inset_x />,
        );
      ...
      test('inset_y', () => {
        const { getByTestId } = render(
          <View.div data-testid="inset_y" inset_y />,
        );
  ...
  describe('Position', () => {
    ...
    test('absolute', () => {
      const { getByTestId } = render(
        <View.div data-testid="absolute" absolute />,
      );
    ...
    test('relative', () => {
      const { getByTestId } = render(
        <View.div data-testid="relative" relative />,
      );
  ...
  describe('Scroll', () => {
    describe('Auto', () => {
      test('sc_auto', () => {
        const { getByTestId } = render(
          <View.div data-testid="sc_auto" sc_auto />,
        );
      ...
      test('scy_auto', () => {
        const { getByTestId } = render(
          <View.div data-testid="scy_auto" scy_auto />,
        );
      ...
      test('scx_auto', () => {
        const { getByTestId } = render(
          <View.div data-testid="scx_auto" scx_auto />,
        );
    ...
    describe('Hidden', () => {
      test('sc_hidden', () => {
        const { getByTestId } = render(
          <View.div data-testid="sc_hidden" sc_hidden />,
        );
      ...
      test('scy_hidden', () => {
        const { getByTestId } = render(
          <View.div data-testid="scy_hidden" scy_hidden />,
        );
      ...
      test('scx_hidden', () => {
        const { getByTestId } = render(
          <View.div data-testid="scx_hidden" scx_hidden />,
        );
    ...
    describe('Visible', () => {
      test('sc_visible', () => {
        const { getByTestId } = render(
          <View.div data-testid="sc_visible" sc_visible />,
        );
      ...
      test('scy_visible', () => {
        const { getByTestId } = render(
          <View.div data-testid="scy_visible" scy_visible />,
        );
      ...
      test('scx_visible', () => {
        const { getByTestId } = render(
          <View.div data-testid="scx_visible" scx_visible />,
        );
  ...
  describe('Visibility', () => {
    ...
    test('visible', () => {
      const { getByTestId } = render(
        <View.div data-testid="visible" visible />,
      );
    ...
    test('invisible', () => {
      const { getByTestId } = render(
        <View.div data-testid="invisible" invisible />,
      );
    ...
    test('noappearance', () => {
      const { getByTestId } = render(
        <View.div data-testid="noappearance" noappearance />,
      );
  ...
  describe('Fit', () => {
    test('fit_contain', () => {
      const { getByTestId } = render(
        <View.div data-testid="fit_contain" fit_contain />,
      );
    ...
    test('fit_cover', () => {
      const { getByTestId } = render(
        <View.div data-testid="fit_cover" fit_cover />,
      );
    ...
    test('fit_fill', () => {
      const { getByTestId } = render(
        <View.div data-testid="fit_fill" fit_fill />,
      );
    ...
    test('fit_none', () => {
      const { getByTestId } = render(
        <View.div data-testid="fit_none" fit_none />,
      );
  ...
  describe('Resize', () => {
    test('rz_none', () => {
      const { getByTestId } = render(
        <View.div data-testid="rz_none" rz_none />,
      );
