...
describe('Background', () => {
  ...
  test('bg_img', () => {
    ...
    const { getByTestId } = render(
      <View.div data-testid="bg_img" bg_img={bg_img} />,
    );
  ...
  test('bg_repeat', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_repeat" bg_repeat />,
    );
  ...
  test('bg_norepeat', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_norepeat" bg_norepeat />,
    );
  ...
  test('bg_cover', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_cover" bg_cover />,
    );
  ...
  test('bg_contain', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_contain" bg_contain />,
    );
  ...
  test('bg_fixed', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_fixed" bg_fixed />,
    );
  ...
  test('bg_local', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_local" bg_local />,
    );
  ...
  test('bg_scroll', () => {
    const { getByTestId } = render(
      <View.div data-testid="bg_scroll" bg_scroll />,
    );
