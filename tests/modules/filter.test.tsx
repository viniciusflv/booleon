...
import { filter } from '../../packages/modules/src/lib/filter';

describe('Filter', () => {
  let FilterComponent;

  beforeAll(() => {
    FilterComponent = hocBooleon((props) => <div {...props} />, filter);
  });

  test('ft_blur_1', () => {
    const { getByTestId } = render(
      <FilterComponent data-testid="ft_blur_1" ft_blur_1 />,
    );
  ...
  test('ft_bn_100', () => {
    const { getByTestId } = render(
      <FilterComponent data-testid="ft_bn_100" ft_bn_100 />,
    );
  ...
  test('ft_hue_10', () => {
    const { getByTestId } = render(
      <FilterComponent data-testid="ft_hue_10" ft_hue_10 />,
    );
  ...
  test('ft_saturate_10', () => {
    const { getByTestId } = render(
      <FilterComponent data-testid="ft_saturate_10" ft_saturate_10 />,
    );
  ...
  test('ft_invert', () => {
    const { getByTestId } = render(
      <FilterComponent data-testid="ft_invert" ft_invert />,
    );
