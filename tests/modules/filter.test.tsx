...
describe('Filter', () => {
  test('ft_blur_1', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_blur_1" ft_blur_1 />,
    );
  ...
  test('ft_bn_100', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_bn_100" ft_bn_100 />,
    );
  ...
  test('ft_contrast_100', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_contrast_100" ft_contrast_100 />,
    );
  ...
  test('ft_grayscale_100', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_grayscale_100" ft_grayscale_100 />,
    );
  ...
  test('ft_hue_10', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_hue_10" ft_hue_10 />,
    );
  ...
  test('ft_opacity_10', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_opacity_10" ft_opacity_10 />,
    );
  ...
  test('ft_saturate_10', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_saturate_10" ft_saturate_10 />,
    );
  ...
  test('ft_sepia_10', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_sepia_10" ft_sepia_10 />,
    );
  ...
  test('ft_invert', () => {
    const { getByTestId } = render(
      <View.div data-testid="ft_invert" ft_invert />,
    );
