...
const BooleonComponent = booleon.div(grid);
describe('Grid', () => {
  test('rows', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="rows" rows_1fr_auto_1px />,
    );
  ...
  test('cols', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="cols" cols_1fr_auto_1px />,
    );
  ...
  test('area', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="area" area_AREA />,
    );
  ...
  test('cols_span', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="cols_span" cols_span_2 />,
    );
  ...
  test('rows_span', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="rows_span" rows_span_2 />,
    );
  ...
  test('cols_start', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="cols_start" cols_start_2 />,
    );
  ...
  test('rows_start', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="rows_start" rows_start_2 />,
    );
  ...
  test('cols_end', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="cols_end" cols_end_2 />,
    );
  ...
  test('rows_end', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="rows_end" rows_end_2 />,
    );
  ...
  test('grid', () => {
    const { getByTestId } = render(
      <BooleonComponent data-testid="grid" grid />,
    );
