...
describe('Cursor', () => {
  ...
  beforeAll(() => {
    CursorComponent = hocBooleon((props) => <div {...props} />, cursor);
  });

  test('cr_auto', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_auto" cr_auto />,
    );
  ...
  test('cr_default', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_default" cr_default />,
    );
  ...
  test('cr_pointer', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_pointer" cr_pointer />,
    );
  ...
  test('cr_wait', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_wait" cr_wait />,
    );
  ...
  test('cr_text', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_text" cr_text />,
    );
  ...
  test('cr_move', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_move" cr_move />,
    );
  ...
  test('cr_disallowed', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_disallowed" cr_disallowed />,
    );
  ...
  test('cr_cross', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_cross" cr_cross />,
    );
  ...
  test('cr_grabbing', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_grabbing" cr_grabbing />,
    );
  ...
  test('cr_help', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_help" cr_help />,
    );
  ...
  test('cry_resize', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cry_resize" cry_resize />,
    );
  ...
  test('cra_resize', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cra_resize" cra_resize />,
    );
  ...
  test('crb_resize', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="crb_resize" crb_resize />,
    );
  ...
  test('crx_resize', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="crx_resize" crx_resize />,
    );
  ...
  test('cr_no_drop', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_no_drop" cr_no_drop />,
    );
  ...
  test('cr_none', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_none" cr_none />,
    );
  ...
  test('cr_progress', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_progress" cr_progress />,
    );
  ...
  test('cr_zoom_in', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_zoom_in" cr_zoom_in />,
    );
  ...
  test('cr_zoom_out', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_zoom_out" cr_zoom_out />,
    );
  ...
  test('cr_noevents', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_noevents" cr_noevents />,
    );
  ...
  test('cr_events', () => {
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_events" cr_events />,
    );
  ...
  test('cr_url', () => {
    ...
    const { getByTestId } = render(
      <CursorComponent data-testid="cr_url" cr_url={cr_url} />,
    );
