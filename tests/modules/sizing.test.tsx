...
describe('Sizing', () => {
  ...
  beforeAll(() => {
    SizingComponent = hocBooleon((props) => <div {...props} />, sizing);
  });

  describe('Height', () => {
    test('h_100', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_100" h_100 />,
      );
    ...
    test('h_max_100', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_max_100" h_max_100 />,
      );
    ...
    test('h_min_100', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_min_100" h_min_100 />,
      );
    ...
    test('h_full', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_full" h_full />,
      );
    ...
    test('h_max_full', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_max_full" h_max_full />,
      );
    ...
    test('h_min_full', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_min_full" h_min_full />,
      );
    ...
    test('h_auto', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_auto" h_auto />,
      );
    ...
    test('h_max_auto', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_max_auto" h_max_auto />,
      );
    ...
    test('h_min_auto', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_min_auto" h_min_auto />,
      );
    ...
    test('h_screen', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_screen" h_screen />,
      );
    ...
    test('h_max_screen', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_max_screen" h_max_screen />,
      );
    ...
    test('h_min_screen', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="h_min_screen" h_min_screen />,
      );
  ...
  describe('Width', () => {
    test('w_100', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_100" w_100 />,
      );
    ...
    test('w_max_100', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_max_100" w_max_100 />,
      );
    ...
    test('w_min_100', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_min_100" w_min_100 />,
      );
    ...
    test('w_full', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_full" w_full />,
      );
    ...
    test('w_max_full', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_max_full" w_max_full />,
      );
    ...
    test('w_min_full', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_min_full" w_min_full />,
      );
    ...
    test('w_auto', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_auto" w_auto />,
      );
    ...
    test('w_max_auto', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_max_auto" w_max_auto />,
      );
    ...
    test('w_min_auto', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_min_auto" w_min_auto />,
      );
    ...
    test('w_screen', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_screen" w_screen />,
      );
    ...
    test('w_max_screen', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_max_screen" w_max_screen />,
      );
    ...
    test('w_min_screen', () => {
      const { getByTestId } = render(
        <SizingComponent data-testid="w_min_screen" w_min_screen />,
      );
