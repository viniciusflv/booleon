...
describe('Shadow', () => {
  ...
  describe('around', () => {
    test('sd_1', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_1" sd_1 />,
      );
    ...
    test('sd_2', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_2" sd_2 />,
      );
    ...
    test('sd_3', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_3" sd_3 />,
      );
    ...
    test('sd_4', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_4" sd_4 />,
      );
    ...
    test('sd_6', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_6" sd_6 />,
      );
    ...
    test('sd_8', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_8" sd_8 />,
      );
    ...
    test('sd_9', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_9" sd_9 />,
      );
    ...
    test('sd_12', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_12" sd_12 />,
      );
    ...
    test('sd_16', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_16" sd_16 />,
      );
    ...
    test('sd_24', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sd_24" sd_24 />,
      );
  ...
  describe('inset', () => {
    ...
    test('sdi_2', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_2" sdi_2 />,
      );
    ...
    test('sdi_3', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_3" sdi_3 />,
      );
    ...
    test('sdi_4', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_4" sdi_4 />,
      );
    ...
    test('sdi_6', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_6" sdi_6 />,
      );
    ...
    test('sdi_8', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_8" sdi_8 />,
      );
    ...
    test('sdi_9', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_9" sdi_9 />,
      );
    ...
    test('sdi_12', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_12" sdi_12 />,
      );
    ...
    test('sdi_16', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_16" sdi_16 />,
      );
    ...
    test('sdi_24', () => {
      const { getByTestId } = render(
        <ShadowComponent data-testid="sdi_24" sdi_24 />,
      );
