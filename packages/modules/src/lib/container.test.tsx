...
describe('Container', () => {
  ...
  describe('Placement', () => {
    describe('Top', () => {
      test('top_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="top_666" top_666 />,
        );
      ...
      test('top_neg_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="top_neg_666" top_neg_666 />,
        );
    ...
    describe('Bottom', () => {
      test('bottom_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="bottom_666" bottom_666 />,
        );
      ...
      test('bottom_neg_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="bottom_neg_666" bottom_neg_666 />,
        );
    ...
    describe('Left', () => {
      test('left_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="left_666" left_666 />,
        );
      ...
      test('left_neg_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="left_neg_666" left_neg_666 />,
        );
    ...
    describe('Right', () => {
      test('right_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="right_666" right_666 />,
        );
      ...
      test('right_neg_666', () => {
        const { getByTestId } = render(
          <BooleonComponent data-testid="right_neg_666" right_neg_666 />,
        );
