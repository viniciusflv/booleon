...
describe('Spacing', () => {
  describe('Margin', () => {
    test('m_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="m_12" m_12 />,
      );
    ...
    test('mt_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="mt_12" mt_12 />,
      );
    ...
    test('mb_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="mb_12" mb_12 />,
      );
    ...
    test('ml_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="ml_12" ml_12 />,
      );
    ...
    test('mr_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="mr_12" mr_12 />,
      );
    ...
    test('mx_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="mx_12" mx_12 />,
      );
    ...
    test('my_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="my_12" my_12 />,
      );
  ...
  describe('Padding', () => {
    test('p_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="p_12" p_12 />,
      );
    ...
    test('pt_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="pt_12" pt_12 />,
      );
    ...
    test('pb_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="pb_12" pb_12 />,
      );
    ...
    test('pl_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="pl_12" pl_12 />,
      );
    ...
    test('pr_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="pr_12" pr_12 />,
      );
    ...
    test('px_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="px_12" px_12 />,
      );
    ...
    test('py_12', () => {
      const { getByTestId } = render(
        <BooleonComponent data-testid="py_12" py_12 />,
      );
