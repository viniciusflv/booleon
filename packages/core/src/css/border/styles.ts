...
const borderCss: Indexer<BorderProps> = [
  ...
  [new RegExp(`^(bbc_)${hexColor}`),(value) => `border-bottom-color: #${value};`,],
  [new RegExp(`^(blc_)${hexColor}`),(value) => `border-left-color: #${value};`,],
  [new RegExp(`^(brc_)${hexColor}`),(value) => `border-right-color: #${value};`,],
  [new RegExp(`^(bxc_)${hexColor}`),(value) => `border-right-color: #${value};border-left-color: #${value};`,],
  [new RegExp(`^(byc_)${hexColor}`),(value) => `border-top-color: #${value};border-bottom-color: #${value};`,],
  ...
  ['br_circular',() => 'border-top-right-radius: 100px;border-bottom-right-radius: 100px;',],
  ['bl_circular',() => 'border-top-left-radius: 100px;border-bottom-left-radius: 100px;',],
  ['bb_circular',() => 'border-bottom-right-radius: 100px;border-bottom-left-radius: 100px;',],
  ['bt_circular',() => 'border-top-right-radius: 100px;border-top-left-radius: 100px;',],
  ...
  ['br_rounded',() => 'border-top-right-radius: 5rem;border-bottom-right-radius: 5rem;',],
  ['bl_rounded',() => 'border-top-left-radius: 5rem;border-bottom-left-radius: 5rem;',],
  ['bb_rounded',() => 'border-bottom-right-radius: 5rem;border-bottom-left-radius: 5rem;',],
  ['bt_rounded',() => 'border-top-right-radius: 5rem;border-top-left-radius: 5rem;',],
  ...
  ['br_edge',() => 'border-top-right-radius: .5rem;border-bottom-right-radius: .5rem;',],
  ['bl_edge',() => 'border-top-left-radius: .5rem;border-bottom-left-radius: .5rem;',],
  ['bb_edge',() => 'border-bottom-right-radius: .5rem;border-bottom-left-radius: .5rem;',],
