...
export const BorderStyle = styled.div<BorderProps>`
  ...
  ${({ btr_circular }) => btr_circular && replicateForPseudo('border-top-right-radius: 100px;')}
  ${({ btr_rounded }) => btr_rounded && replicateForPseudo('border-top-right-radius: 2rem;')}
  ${({ btr_edge }) => btr_edge && replicateForPseudo('border-top-right-radius: .5rem;')}
  ${({ btl_circular }) => btl_circular && replicateForPseudo('border-top-left-radius: 100px;')}
  ${({ btl_rounded }) => btl_rounded && replicateForPseudo('border-top-left-radius: 2rem;')}
  ${({ btl_edge }) => btl_edge && replicateForPseudo('border-top-left-radius: .5rem;')}
  ${({ bbr_circular }) => bbr_circular && replicateForPseudo('border-bottom-right-radius: 100px;')}
  ${({ bbr_rounded }) => bbr_rounded && replicateForPseudo('border-bottom-right-radius: 2rem;')}
  ${({ bbr_edge }) => bbr_edge && replicateForPseudo('border-bottom-right-radius: .5rem;')}
  ${({ bbl_circular }) => bbl_circular && replicateForPseudo('border-bottom-left-radius: 100px;')}
  ${({ bbl_rounded }) => bbl_rounded && replicateForPseudo('border-bottom-left-radius: 2rem;')}
  ${({ bbl_edge }) => bbl_edge && replicateForPseudo('border-bottom-left-radius: .5rem;')}
`;
