...
```mermaid
  ...
  click styleCompiler "//#styleCompiler" "styleCompiler"
  click stringHash "//#stringHash" "stringHash"
  click composeProps "//#composeProps" "composeProps"
  click booleonModules "/docs/modules" "booleonModules"
  click customPrefixes "//#customPrefixes" "customPrefixes"
  click cleanTransformFilter "//#cleanTransformFilter" "cleanTransformFilter"
  click defaultPrefixes "//#defaultPrefixes" "defaultPrefixes"
  click prefixerHandlers "//#prefixerHandlers" "prefixerHandlers"
  click cssCompiler "//#cssCompiler" "cssCompiler"
  click browserPrefixer "//#browserPrefixer" "browserPrefixer"
```
...
The motivation for this feature was, allowing the [transform](/docs/modules/#transform) and
[filter](/docs/modules/#filter) modules to have, not only css values, but also its attributes.
